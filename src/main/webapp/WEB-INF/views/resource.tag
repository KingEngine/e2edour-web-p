...
<script src="${staticFileRoot}/js/jquery.bootstrap.min.js"></script>
<script src="${staticFileRoot}/bootstrapvalidator/js/language/zh_CN.js"></script>
<script src="${staticFileRoot}/js/jquery.bootpag.min.js"></script>